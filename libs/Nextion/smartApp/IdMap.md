...
**Модули:** `smartApp/nexIdMap.*`, `smartApp/nexSmartApp.*`, `Route::kCompIdMapPoll*` в `core/nexTypes.hpp`.
...
| | |
|---|---|
| **Файлы** | `smartApp/nexIdMap.hpp/cpp` |
| **Сложность** | M |
...
| | |
|---|---|
| **Файлы** | `smartApp/nexSmartApp.hpp/cpp` |
| **Сложность** | M |
...
| | |
|---|---|
| **Файлы** | `smartApp/nexIdMap.cpp`, `smartApp/nexSmartApp.cpp` |
| **Сложность** | S |
...
| | |
|---|---|
| **Файлы** | `smartApp/nexSmartApp.cpp` |
| **Сложность** | S |
...
| | |
|---|---|
| **Файлы** | `smartApp/nexSmartApp.cpp`, `comp/nexComponentBase.hpp` (registry API) |
| **Сложность** | M |
