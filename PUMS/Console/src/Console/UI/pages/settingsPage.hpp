...
struct SettingsPage : nex::Page<23> {
    ...
    HMI_COMP_GLOBAL(Number<>, nThour);
    HMI_COMP_GLOBAL(Number<>, nTmin);
    HMI_COMP_GLOBAL(Number<>, nTsec);
    HMI_COMP_GLOBAL(Number<>, nDday);
    HMI_COMP_GLOBAL(Number<>, nDmon);
    HMI_COMP_GLOBAL(Number<>, nDyear);
